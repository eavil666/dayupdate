...
# B档：通用工具与自动更新逻辑已拆分至独立模块（单向依赖，updater 不依赖业务模块）
from common import (script_dir, runtime_dir, meipass_dir,
                    _log, _set_progress, set_gui_callbacks, _find_file)
...
# ================ 版本 & 自动更新 ================
APP_VERSION = "1.5.0"
# 自动更新逻辑已拆分至 updater.py（AutoUpdater / 更新源配置 / SSL 降级 / update_worker_main）
